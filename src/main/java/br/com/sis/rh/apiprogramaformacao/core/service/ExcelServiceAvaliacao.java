...
public class ExcelServiceAvaliacao {
	...
	public ByteArrayInputStream gerarRelatorioAvaliacoes(RelatorioAvaliacoesVo avaliacaoVo) throws IOException {
		try(Workbook workbook = new XSSFWorkbook()){
	        ...
	        dataRow.createCell(2).setCellValue(avaliacaoVo.getNotaMediaAvaliacaoPraticasAgeis());
	        dataRow.createCell(3).setCellValue(avaliacaoVo.getNotaMediaAvaliacaoLideranca());
	        dataRow.createCell(4).setCellValue(avaliacaoVo.getNotaMediaAvaliacaoNegocio());
	        dataRow.createCell(5).setCellValue(avaliacaoVo.getUltimoCicloRegistrado());
