...
import br.com.sis.rh.apiprogramaformacao.core.repository.acompanhamento.AvaliacaoDesempenhoRepository;
import br.com.sis.rh.apiprogramaformacao.core.repository.informacoesgerais.ParticipanteRepository;
import br.com.sis.rh.apiprogramaformacao.core.repository.relatorios.AvaliacaoRepository;
...
public class AvaliacoesService {
	...
	public ResponseEntity<AvaliacoesDto> cadastrar( String cpf,  AvaliacoesForm avaliacoesForm) {
		...
		if (participante.isPresent()) {
			...
			URI uri = UriComponentsBuilder.newInstance().path("/avaliacoes/novo/{id}").buildAndExpand(avaliacoes.getId()).toUri();
