...
public interface InvestimentoInstrutorRepository extends JpaRepository<FiltragemInstrutorDto, String> {

    @Query(value = "SELECT ins.nome_instrutor AS nome_instrutor, pro.nome AS nome_programa, pro.nome_turma AS nome_turma, pro.vlr_hora_instrutor as valor_hora " +
